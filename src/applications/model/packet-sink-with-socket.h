...
#ifndef PACKET_SINK_WITH_SOCKET_H
#define PACKET_SINK_WITH_SOCKET_H
 ...
 * \defgroup packetsink PacketSinkWithSocket
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a PacketSinkWithSocket name was selected.  Functionally it is
 ...
 */
class PacketSinkWithSocket : public Application 
{
public:
  /**
  ...
  PacketSinkWithSocket ();

  virtual ~PacketSinkWithSocket ();
  ...
  void Setup(Ptr<Socket> socket, Address local);
...
#endif /* PACKET_SINK_WITH_SOCKET_H */
