...
#ifndef BULK_SEND_WITH_SOCKET_APPLICATION_H
#define BULK_SEND_WITH_SOCKET_APPLICATION_H
 ...
 * \defgroup bulksend BulkSendWithSocketApplicationWithSocket
 *
 ...
 *
 */
class BulkSendWithSocketApplication : public Application
{
public:
  /**
  ...
  BulkSendWithSocketApplication ();

  virtual ~BulkSendWithSocketApplication ();
  ...
  void Setup(Ptr<Socket> socket, Address peer, uint32_t sendSize);
...
#endif /* BULK_SEND_WITH_SOCKET_APPLICATION_H */
